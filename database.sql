...
create table public.songs (
    ...
    constraint public_songs_user_id_fkey foreign key (user_id) references users (id) on update cascade
...
create table public.liked_songs (
    ...
    constraint public_liked_songs_song_id_fkey foreign key (song_id) references songs (id) on update cascade,
    constraint public_liked_songs_user_id_fkey foreign key (user_id) references users (id) on update cascade
) tablespace pg_default;